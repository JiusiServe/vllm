...
from vllm.v1.outputs import (EMPTY_MODEL_RUNNER_OUTPUT, AsyncModelRunnerOutput,
                             DraftTokenIds, ECConnectorOutput, LogprobsLists, LogprobsTensors,
                             ModelRunnerOutput, PoolerOutput, SamplerOutput, make_empty_encoder_model_runner_output)
...
class GPUModelRunner(
    ...
    def _preprocess(
        ...
        num_tokens_after_padding: Optional[torch.Tensor] = None,
               ...
               Optional[IntermediateTensors], dict[str, Any], Optional[ECConnectorOutput]]:
